...
public class Contenedor {
	   /*
	    * Lista de instancias de la interfaz Asesoria.
	    * Lista de instancias de la clase Capacitación.
	    */
	    ...
	    * Elimina el usuario si se encuentra en la lista, verificando que el objeto
	    * sea una instancia de la clase Usuario.
	    */
	   ...
	   /*
	    * Método para listar usuarios por un tipo específico de Usuario.
	    * La clase específica de Usuario que se desea listar (por ejemplo, Cliente, Profesional).
	    * Filtra e imprime en la consola los objetos que son instancias del tipo especificado.
	    */
	   ...
	   /*
	    * Método para listar todas las capacitaciones almacenadas en la lista de capacitaciones.
	    * Imprime en la consola la representación en cadena de cada capacitación.
	    */
