 ...
 *
 * Implementa la interfaz Asesoria Crea el método analizarUsuario() para ser
 * usado en otras clases, desde la interfaz Asesoria
 *
...
// Método constructor sin parámetros
	...
	public void setFechaNacimiento(String fechaNacimiento) {
		try {
			...
			LocalDate.parse(fechaNacimiento, dtf);
			this.fechaNacimiento = fechaNacimiento;
	...
	// Validación para el RUN, debe ser un número válido y estar en el rango
	// permitido de 0-99999999
	 ...
	 * Método mostrarEdad()
	 *
	 * Calcula la edad del usuario basado en la fecha de nacimiento. Devuelve un
	 * mensaje con la edad.
	 */
	 ...
	 *
	 * Indica el nombre del usuario con una descripción de su rol en la empresa Hace
	 * uso de this instanceof para identificar la clase a la que se refiere, y a
	 * partir de ahí imprimir el nombre de su cargo y nombre
	 */
	@Override
